static gint
rsvp_equal(gconstpointer th, gconstpointer wi)
{
	const struct rsvp_request_key *key1 = (const struct rsvp_request_key *)th;
	const struct rsvp_request_key *key2 = (const struct rsvp_request_key *)wi;
