static gint
rsvp_equal(gconstpointer of, gconstpointer ra)
{
    const struct rsvp_request_key *key1 = (const struct rsvp_request_key *)of;
    const struct rsvp_request_key *key2 = (const struct rsvp_request_key *)ra;
