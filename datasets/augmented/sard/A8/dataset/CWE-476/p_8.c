void dissect_nds_request(tvbuff_t *sz, packet_info *na,
                         guint32 hs, guint8 rr,
                         guint16 zj, proto_tree *vi)
{
    ...
    func = tvb_get_guint8(sz, 6);
    subfunc = tvb_get_guint8(sz, 7);

    ncp_rec = ncp_record_find(func, subfunc);

    nds_frag = tvb_get_letohl(sz, 8);

    if (nds_frag == 0xffffffff)
    {

        nds_verb = tvb_get_guint8(sz, 24);
        if (nds_verb == 0xfe)
        {
            nds_version = nds_verb;
            nds_verb = tvb_get_guint8(sz, 32);
            foffset = 36;
        }
        else
        {
        ...
        if (zj == NCP_SERVICE_REQUEST)
        {
            proto_tree_add_item(vi, hf_nds_buffer_size, sz, foffset,
                                4, TRUE);
        }
        foffset = foffset + 4;
        ...
        case 0x01:
            pvalues[0].vvalue = tvb_get_letohl(sz, foffset);
            ...
            pvalues[1].vvalue = tvb_get_letohl(sz, foffset);
            ...
            if (pvalues[0].vvalue == 0 || pvalues[0].vvalue == 1)
            {
                ...
                pvalues[2].vvalue = tvb_get_letohl(sz, foffset);
                ...
                pvalues[3].vlength = tvb_get_letohl(sz, foffset);
                if (pvalues[3].vlength == 0x00 || !tvb_bytes_exist(sz, foffset, pvalues[3].vlength))
                {
                ...
                foffset = foffset + 4;
                pvalues[3].vstring = get_string(sz, pvalues[3].voffset, pvalues[3].vlength);
                g_strlcpy(global_object_name, pvalues[3].vstring, 256);
                pvalues[3].hfname = hf_nds_name;
                foffset = foffset + pvalues[3].vlength;
                foffset += align_4(sz, foffset);
                pvalues[4].vvalue = tvb_get_letohl(sz, foffset);
                ...
                pvalues[5].vvalue = tvb_get_letohl(sz, foffset);
            ...
            else
            {
                ...
                foffset = foffset + pvalues[2].vlength;
                pvalues[3].vvalue = tvb_get_letohl(sz, foffset);
                ...
                pvalues[6].vvalue = tvb_get_letohl(sz, foffset);
                ...
                pvalues[7].vlength = tvb_get_letohl(sz, foffset);
                pvalues[7].voffset = foffset + 4;
                foffset = foffset + 4;
                pvalues[7].vstring = get_string(sz, pvalues[7].voffset, pvalues[7].vlength);
                pvalues[7].hfname = hf_nds_output_delimiter;
                foffset = foffset + pvalues[7].vlength;
                foffset += align_4(sz, foffset);
                pvalues[8].vvalue = tvb_get_letohl(sz, foffset);
        ...
        case 0x02:
            ...
            case 2:
                ...
                foffset = foffset + 4;
                pvalues[3].vvalue = tvb_get_letohs(sz, foffset);
                global_flags = tvb_get_letohl(sz, foffset);
                ...
                foffset = foffset + 2;
                pvalues[4].vvalue = tvb_get_letohs(sz, foffset);
        ...
        case 0x04:
            ...
            pvalues[2].vlength = tvb_get_letohl(sz, foffset);
            if (pvalues[2].vlength == 0x00 || !tvb_bytes_exist(sz, foffset, pvalues[2].vlength))
            {
            ...
            foffset = foffset + 4;
            pvalues[2].vstring = get_string(sz, pvalues[2].voffset, pvalues[2].vlength);
        ...
        case 0x05:
            ...
            foffset = foffset + 2;
            pvalues[5].vvalue = tvb_get_letohs(sz, foffset);
            ...
            pvalues[6].vlength = tvb_get_letohl(sz, foffset);
            pvalues[6].voffset = foffset + 4;
            foffset = foffset + 4;
            pvalues[6].vstring = get_string(sz, pvalues[6].voffset, pvalues[6].vlength);
        ...
        case 0x06:
            ...
            {
                pvalues[7].vvalue = tvb_get_letohs(sz, foffset);
                global_flags = tvb_get_letohl(sz, foffset);
                ...
                foffset = foffset + 2;
                pvalues[8].vvalue = tvb_get_letohs(sz, foffset);
        ...
        case 0x07:
            ...
            else
            {
                ...
                pvalues[4].vlength = tvb_get_letohl(sz, foffset);
                if (pvalues[4].vlength == 0x00 || !tvb_bytes_exist(sz, foffset, pvalues[4].vlength))
                {
                ...
                foffset = foffset + 4;
                pvalues[4].vstring = get_string(sz, pvalues[4].voffset, pvalues[4].vlength);
        ...
        case 0x0b:
            ...
            pvalues[0].hfname = hf_nds_ver;
            foffset = foffset + pvalues[0].vlength;
            pvalues[1].vvalue = tvb_get_letohs(sz, foffset);
            global_flags = tvb_get_letohl(sz, foffset);
            pvalues[1].vtype = VTYPE_BITFIELD;
        ...
        case 0x0d:
            ...
            pvalues[1].vlength = tvb_get_letohl(sz, foffset);
            if (pvalues[1].vlength == 0x00 || !tvb_bytes_exist(sz, foffset, pvalues[1].vlength))
            {
            ...
            foffset = foffset + 4;
            pvalues[1].vstring = get_string(sz, pvalues[1].voffset, pvalues[1].vlength);
        ...
        case 0x2a:
            ...
            pvalues[4].vlength = 256;
            pvalues[4].vlength = tvb_get_letohl(sz, foffset);
            if (pvalues[4].vlength == 0x00 || !tvb_bytes_exist(sz, foffset, pvalues[3].vlength))
            {
                pvalues[4].vtype = VTYPE_NONE;
                break;
            }
        ...
        case 0x2b:
            ...
            pvalues[5].vlength = tvb_get_letohl(sz, foffset);
            if (pvalues[5].vlength == 0x00 || !tvb_bytes_exist(sz, foffset, pvalues[3].vlength))
            {
            ...
            foffset = foffset + 4;
            pvalues[5].vstring = get_string(sz, pvalues[5].voffset, pvalues[5].vlength);
    ...
    if (check_col(na->cinfo, COL_INFO))
    {
        if (ncp_rec)
        {
            col_set_str(na->cinfo, COL_PROTOCOL, "NDS");
            if (nds_frag != 0xffffffff)
            {
                col_add_fstr(na->cinfo, COL_INFO, "C Continue NDS Fragment 0x%08x", nds_frag);
            }
            else
            {
                col_add_fstr(na->cinfo, COL_INFO, "C NDS %s", verb_string);
            }
            run_info_str = TRUE;
        }
        else
        {
            col_add_fstr(na->cinfo, COL_INFO,
                         "C Unknown Function %d (0x%02x)",
                         func, func);
        }
    }

    conversation = find_conversation(na->fd->num, &na->src, &na->dst,
                                     PT_NCP, hs, hs, 0);
    if (conversation == NULL)
    {
        conversation = conversation_new(na->fd->num, &na->src, &na->dst,
                                        PT_NCP, hs, hs, 0);
    }

    if (!pinfo->fd->flags.visited)
    {
        request_value = ncp_hash_insert(conversation, rr, ncp_rec);
        request_value->req_frame_num = na->fd->num;
        request_value->req_frame_time = na->fd->abs_ts;
        if (ncp_rec && !ncp_tree)
        {
            run_req_cond = TRUE;
        }
    ...
    if ((run_info_str || run_req_cond) && !ncp_tree)
    {
        ...
        ti = proto_tree_add_item(temp_tree, proto_ncp, sz, 0, -1, FALSE);
        vi = proto_item_add_subtree(ti, ett_ncp);
    }
    ...
    if (vi)
    {
        ...
        PTREE_DATA(vi)->visible = 1;
#endif

        request_value = ncp_hash_lookup(conversation, rr);
        switch (zj)
        {
        ...
        case NCP_SERVICE_REQUEST:
            ...
            ptvc = ptvcursor_new(vi, sz, 7);
            if (ncp_rec && ncp_rec->request_ptvc)
            {
                clear_repeat_vars();
                process_ptvc_record(ptvc, ncp_rec->request_ptvc, NULL, TRUE, ncp_rec);
            }
            proto_tree_add_uint_format(vi, hf_ncp_func, sz, 6, 1,
                                       func, "Function: %d (0x%02X), %s",
                                       func, func, ncp_rec ? ncp_rec->name : "Unknown");

            proto_tree_add_uint_format(vi, hf_ncp_subfunc, sz, 7, 1,
                                       subfunc, "SubFunction: %d (0x%02x)",
                                       subfunc, subfunc);

            proto_tree_add_uint(vi, hf_ncp_fragment_handle, sz, 8, 4,
                                nds_frag);

            if (nds_frag == 0xffffffff)
            {

                proto_tree_add_item(vi, hf_ncp_fragment_size, sz, 12, 4, TRUE);

                proto_tree_add_item(vi, hf_ncp_message_size, sz, 16, 4, TRUE);

                nds_prot_flags = tvb_get_letohs(sz, 22);
                ...
                process_bitfield(vi, sz, &prot_flags[0]);

                if (nds_version == 0)
                {
                    proto_tree_add_uint_format(vi, hf_ncp_nds_verb, sz, 24, 4,
                                               nds_verb, "NDS Verb: %d, (0x%02x), %s",
                                               nds_verb, nds_verb, verb_string);
                }
                else
                {
                    proto_tree_add_uint_format(vi, hf_ncp_nds_verb, sz, 32, 4,
                                               nds_verb, "NDS Verb: %d, (0x%02x), %s",
                                               nds_verb, nds_verb, verb_string);
                }
                added_arrow = FALSE;
                for (i = 0; i < 9; i++)
                {
                    ...
                    case VTYPE_UINT8:
                        proto_tree_add_uint_format(vi, pvalues[i].hfname, sz, pvalues[i].voffset,
                    ...
                    case VTYPE_STRING:
                        proto_tree_add_string_format(vi, pvalues[i].hfname, sz, pvalues[i].voffset,
                        ...
                        if (pvalues[i].mvtype == MVTYPE_ATTR_REQUEST)
                        {
                            ...
                            if (check_col(na->cinfo, COL_INFO))
                            {
                                if (!added_arrow)
                                {
                                    col_append_str(na->cinfo, COL_INFO, " -> ");
                                    added_arrow = TRUE;
                                }
                                col_append_str(na->cinfo, COL_INFO, pvalues[i].vstring);
                            }
                        }
                        break;

                    case VTYPE_BITFIELD:
                        process_bitfield(vi, sz, &pvalues[i]);
                        break;

                    case VTYPE_MULTIVALUE_UINT32:
                        process_multivalues(vi, sz, na, &pvalues[i]);
                        ...
                        if (pvalues[i].mvtype == MVTYPE_ATTR_REQUEST || pvalues[i].mvtype == MVTYPE_PROC_ENTRY_SPECIFIERS || pvalues[i].mvtype == MVTYPE_PROCESS_ITERATOR)
                        {
                            if (check_col(na->cinfo, COL_INFO))
                            {
                                ...
                                if (pvalues[i].mvtype != MVTYPE_PROCESS_ITERATOR)
                                {
                                    ...
                                    col_append_str(na->cinfo, COL_INFO, mv_resolve_name_string);
                                }
                            }
                        }
                        break;
                    ...
                    case VTYPE_BYTES:
                        proto_tree_add_bytes(vi, pvalues[i].hfname, sz, pvalues[i].voffset,
                                             pvalues[i].vlength, tvb_get_ptr(sz, pvalues[i].voffset, pvalues[i].vvalue));
                        break;

                    case VTYPE_BOOLEAN:
                        proto_tree_add_item(vi, pvalues[i].hfname, sz, pvalues[i].voffset, pvalues[i].vlength, TRUE);
                        break;

                    default:
                        proto_tree_add_uint_format(vi, hf_nds_p1type, sz, pvalues[i].voffset,
                                                   pvalues[i].vlength, pvalues[i].vtype, "NDS Parameter not defined %u",
                                                   pvalues[i].vtype);
                        break;
                    }
                ...
                if (resolve_eid)
                {
                    if (request_eid_value)
                    {
                        ...
                        if (check_col(na->cinfo, COL_INFO))
                        {
                            col_append_str(na->cinfo, COL_INFO, ", Object Name - ");
                            col_append_str(na->cinfo, COL_INFO, global_object_name);
                        }
                    }
                }
                if (request_value)
