static gint
rsvp_equal(gconstpointer pm, gconstpointer wp)
{
    const struct rsvp_request_key *key1 = (const struct rsvp_request_key *)pm;
    const struct rsvp_request_key *key2 = (const struct rsvp_request_key *)wp;
