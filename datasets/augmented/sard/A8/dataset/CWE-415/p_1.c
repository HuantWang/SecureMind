tvbuff_t *
tvb_uncompress(tvbuff_t *xa, int ad, int gm)
{
	...
	guint bytes_in = tvb_length_remaining(xa, ad);
#endif
	...
	bufsiz = tvb_length_remaining(xa, ad) * 2;
